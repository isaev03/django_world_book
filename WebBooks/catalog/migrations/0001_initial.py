# Generated by Django 3.2.7 on 2022-11-12 22:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_birth', models.DateField(blank=True, help_text='Введите имя автора', null=True, verbose_name='Имя автора')),
                ('date_of_death', models.DateField(blank=True, help_text='Введите имя автора', null=True, verbose_name='Имя автора')),
            ],
        ),
        migrations.CreateModel(
            name='Book',
            fields=[
                ...
                ('summary', models.TextField(help_text='Введите краткое описание для книги', max_length=1000, verbose_name='Аннотация книги')),
                ('isbn', models.CharField(help_text='Должно содержать 13 символов', max_length=13, verbose_name='ISBN книги')),
                ('author', models.ManyToManyField(help_text='Выберите автора для книги', null=True, to='catalog.Author', verbose_name='Автора книги')),
            ],
        ),
        migrations.CreateModel(
            name='Genre',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Введите статус экземпляра книги', max_length=20, verbose_name='Статус экземляра книги')),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('inv_num', models.CharField(help_text='Введите инвертарный номер экземпляра', max_length=20, null=True, verbose_name='Инвертарный номер')),
                ...
                ('status', models.ForeignKey(help_text='Изменить состояние экземпляра', on_delete=django.db.models.deletion.CASCADE, to='catalog.status', verbose_name='Статус экземпляра книги')),
            ],
        ),
        migrations.AddField(
            model_name='book',
